  ...
  return (
    <footer className="bg-[var(--color-primary)] text-white/80 pt-20 pb-10">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        <div>
          <h2 className="text-4xl md:text-5xl font-serif text-white mb-4">{t.footer.ctaTitle}</h2>
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24 mb-16">
        ...
        {/* Contact & Location */}
        <div>
          <h4 className="text-[10px] uppercase tracking-widest text-[#D4E89C] font-bold mb-6">{t.footer.contactTitle}</h4>
        ...
        {/* Links */}
        <div>
          <h4 className="text-[10px] uppercase tracking-widest text-[#D4E89C] font-bold mb-6">{t.footer.linksTitle}</h4>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] uppercase tracking-wider font-light text-white/50">
        ...
        <div className="flex gap-6">
          <Link href="/pravilnik-o-zasebnosti" className="hover:text-white transition-colors">{t.footer.privacyPolicy}</Link>
          <Link href="/pogoji-poslovanja" className="hover:text-white transition-colors">{t.footer.terms}</Link>
        </div>
      </div>
    </footer>
  );
